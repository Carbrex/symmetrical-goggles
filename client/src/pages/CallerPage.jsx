  ...
  return (
    <>
      ...
      <Container>
        ...
        <Card>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '10px', height: ('50vh') }}>
                ...
                <>
                  <div style={{
                    ...
                    <img
                      src={micGif}
                      alt="mic"
                      style={{ height: "15vw", width: '18vw', borderRadius: '3%' }}
                    />
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
                      ...
                      <img
                        ...
                        alt="sentiment"
                        style={{ width: "20vw", height: "10vw", objectFit: "contain" }}
                      />
                    </div>
                  </div>
                </>
